...
class User {
  constructor(name, surname) {
    if (this.constructor === User) {
      //лучше всегда ===  если создатель объекта этот класс - выкинет ошибку
...
class PremiumUser extends User {
  constructor(name, surname, premiumExpiration) {
    super(name, surname); //строго ДО this! super - вызов конструктор базового коласса User, берем оба this оттуда и продолжаем с добавлением уникальным свойством ниже
