...
//из контейнера возьми последний тэг и если он есть - удали, а если нет - ничего не делай

const cloneButtonEl = document.querySelector("#cloneButton");
cloneButtonEl.addEventListener("click", () => {
  const newBox = containerEl.lastElementChild?.cloneNode(true); // а то без дивконтента скопирует
  if (newBox) {
